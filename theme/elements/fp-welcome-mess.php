		...
		<div class="row align-middle">
			...
			<div class="column small-12 medium-6 large-8">
				...
				<div class="message--paragraph">
					...
					<p>当事務所では，さまざまな分野の法律問題を取り扱っていますが，その中でも，<a href="<?php echo get_page_link( '1256' ); ?>">「交通事故」</a>，<a href="<?php echo get_page_link( '1269' ); ?>">「相続」</a>及び<a href="https://hiroshima-kigyo.com" target="_blank">「企業法務」</a>の各分野については，専門チームを設けて，日々研鑽に努めています。</p>
